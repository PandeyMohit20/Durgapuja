...
<title>Wishing You Happy Navratri</title>
  <meta name="google" value="notranslate">
    <meta property="og:type" content="Make your own wonderful wish for you loved once" />
    <meta property="og:title" content="Wishing You Happy Navratri" />
    <meta property="og:url" content="Your Website Link Here>
    <meta property="og:description" content="CLICK HERE" />
    <meta property="og:site_name" content="Create Wishing you happy Navratri" />
...
body {
    background: url("../jaldi-dekho.com/Snow_falling1.gif");
...
<div align="center html2canvas-ignore">
     <div style="font-size: 17px; font-weight: 800; color:#1f8b1c;">
<p id="demo"></p>
...
<img src="Snow_falling1.gif" class="swing1" alt="Republic Day" style="width: 100%; height:100px;">

<h3>Wishing You</h3>
<h2>Happy Durga Puja</h2>
<h2> <img src="navtri.png" class="img-responsive" alt="NEW YEAR" width="80%">
</h2>
...
var countDownDate = new Date("Oct 14, 2018 00:00:00").getTime();
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "Enjoy This Puja";
  }
}, 1000);
</script>       
</div>
</div>
<p aling="center" style="font-size: 15px;color:#f05c00;"><b></p>
 Enjoy this durga puja with your friends and family!!<br></p></b></p>

  <img src="15.png" height="40px" width="40px"/>
<div class="busi"><p style="text-transform: uppercase;"> 
    
    <?php
    $from=$_GET['from'];
    echo "<span style=\"color: purple; font-size: 20px\">Wished By </span>";
echo $_GET['from'];
?>
<br></p>
<center>
<!-- adsense code goes here -->
 ...
 <center>
    <script type="text/javascript">
        var stringurl="whatsapp://send?text=Touch this blue line enter your name and see magic 👉 https://codespeedy.com/demophp/design/durga?from="+a;
        document.write('<a class="footerbtn" href="'+stringurl+'"><img width="25px" height="25px" src="wp.png"/><b style="font-size: 15px;"> Click Here to Share on Whatsapp</b> <img width="25px" height="25px" src="wp.png"/></a>');
